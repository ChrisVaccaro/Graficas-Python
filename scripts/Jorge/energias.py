...
ax2.legend(loc='upper left', fontsize=25,bbox_to_anchor=(0, 0.80))
"""
ax.yaxis.grid(color='lightgray')
ax.plot(df['Fecha'] ,df['Reactive Energy (kVARh) Meter'],linewidth=4)
ax.plot(df['Fecha'] ,df['Reactive Energy (kVARh) PQA'],linewidth=4)
ax.set_ylim([-3,7])
